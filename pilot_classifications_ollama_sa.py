...
checkpoint0 = datetime.now() # start runtime counte
...
SAMPLE_SIZE = 90
df = pd.read_excel("home/bah17005/gold_standard_recalls.xlsx") # for the hpc interactive job
...
checkpoint3 = datetime.now() # start runtime counter
